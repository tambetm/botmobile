...
import argparse
import socket
import driver_steer as driver
from replay_memory_steer import ReplayMemory
from deepqnetwork_steer import DeepQNetwork
import random
...
net = DeepQNetwork(21, args)
agent = driver.Driver(mem, net, args)
